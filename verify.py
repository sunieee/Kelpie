...
suffix = f'.{args.filter}' if args.filter != 'none' else ''
with open(f"out/{args.model}_{args.dataset}/output_end_to_end_{args.metric}{args.topN}{suffix}.json", "w") as outfile:
